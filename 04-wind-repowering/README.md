...
**Data:** US Wind Turbine Database pulled from the USGS API on 2026-09-03 (`data/uswtdb/`), 75,727 turbines carrying a retrofit flag and a retrofit year, plus the April 2018 archived release for pre-repowering rotor diameters and capacity. Joined to EIA-923 plant-level generation for 2013 to 2025 (`data/eia923/`), 14,077 plant-years across 1,486 wind plants.
