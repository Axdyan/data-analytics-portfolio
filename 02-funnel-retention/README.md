...
**Key finding:** The funnel's biggest leak sits before the cart, not after, three in four sessions that view a product never add anything to a cart, while cart-to-purchase conversion is a comparatively gentle 1 in 6. That leaves $23.99M of $29.86M in cart value, 80.3%, unconverted, and month-1 retention falls off a cliff for every cohort except one unexplained outlier. Full writeup in [`memo/findings.md`](memo/findings.md).
